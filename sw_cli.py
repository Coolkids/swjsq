...
from sw_compat import text_type
from sw_core import SWJSQClient, fast_d1ck
from sw_core import TYPE_NORMAL_ACCOUNT, TYPE_NUM_ACCOUNT
from sw_exceptions import APIError, LoginError, UpgradeError

...
from sw_compat import binary_type, text_type
from sw_compat import URLError
from sw_exceptions import APIError, LoginError, SWJSQError, UpgradeError
from sw_http import get as http_get
from sw_rsa import rsa_encrypt
from sw_utils import get_mac
...
class SWJSQClient(XunleiClient):
    ...
    def _get_api_url(self):
        ...
        PORTAL_URLS = [
            u'http://api.upportal.swjsq.vip.xunlei.com/v2/queryportal',
        ]
